	...
	public void handleInput() {
		...
		case IZQUIERDA:
			...
			if(bomberActual.estaVivo() == false)
				hilo.broadcast(new MsgEliminarBomberman(bomberActual.getIdBomberman()), socketsSala);
			else
				hilo.broadcast(new MsgPosBomberman(bomberActual.obtenerID(), bomberActual.getX(), bomberActual.getY()), socketsSala);
			break;
		...
		case BOMBA:
			...
			hilo.broadcast(new MsgPonerBomba(bomberActual.getX(), bomberActual.getY(), bomberActual), socketsSala);
			break;
