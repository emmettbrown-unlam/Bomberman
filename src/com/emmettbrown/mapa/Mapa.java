...
//	 */
//
	public void moverBombermanArriba(Bomberman bomberman, int desplazamiento,Cliente cli) {
		bomberman.cambiarImagenArriba();
		cli.enviarMsg(new MsgMover(bomberman,0,-Math.abs(desplazamiento),conjuntoEntidades));
//		this.moverBomberman(bomberman, 0, -Math.abs(desplazamiento));
		
	}

	public void moverBombermanAbajo(Bomberman bomberman, int desplazamiento,Cliente cli) {
		bomberman.cambiarImagenAbajo();
		cli.enviarMsg(new MsgMover(bomberman,0,Math.abs(desplazamiento),conjuntoEntidades));
//		this.moverBomberman(bomberman, 0, Math.abs(desplazamiento));
	}

	public void moverBombermanIzq(Bomberman bomberman, int desplazamiento,Cliente cli) {
		bomberman.cambiarImagenIzquierda();
		cli.enviarMsg(new MsgMover(bomberman,-Math.abs(desplazamiento),0,conjuntoEntidades));
//		this.moverBomberman(bomberman, -Math.abs(desplazamiento), 0);
		
	}

	public void moverBombermanDer(Bomberman bomberman, int desplazamiento,Cliente cli) {
...
//		this.moverBomberman(bomberman, Math.abs(desplazamiento), 0);
	...
	public void miBomber(Bomberman miBomber) {
		this.miBomber = miBomber;
	}
	
	public Ubicacion obtenerLugarLibre() {
		return null;
	}
}
